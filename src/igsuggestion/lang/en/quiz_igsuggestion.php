...
$string['igsuggestion'] = 'Indonesian Essay Grades';
$string['igsuggestiondownload'] = 'Indonesian grades download';
$string['igsuggestionfilename'] = 'grades';
$string['igsuggestionreport'] = 'Grades report';
$string['igsuggestionreportgraph'] = 'Overall number of students achieving grade ranges';
$string['igsuggestionreportgraphgroup'] = 'Number of students in group \'{$a}\' achieving grade ranges';
$string['pagesize'] = 'Page size';
$string['pluginname'] = 'Indonesian Essay Grades';
